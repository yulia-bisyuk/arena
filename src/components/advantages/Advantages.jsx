    ...
    <section className='services-area pt-100 pb-70'>
      <div className='container'>
        <div className='section-title'>
          ...
          <p>
            «Арена Сіті» не схожий на інші бізнес центри. Розташування в самому
            серці міста, старовинна архітектура, унікальна інфраструктура та
            зручна транспортна розв'язка роблять його особливим.
          </p>
        </div>
        <div className='row'>
